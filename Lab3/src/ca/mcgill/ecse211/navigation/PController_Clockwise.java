 ...
 */
public class PController_Clockwise implements UltrasonicController {
  ...
  public PController_Clockwise(int bandCenter, int bandwidth) {
  ...
  public void processUSData(int distance) {
    ...
    else if (dist_ERR > 0)
    {
    	...
    	if (distance <= 7)
    	{
    		lab3.rightMotor.setSpeed(115);
    		lab3.leftMotor.setSpeed(160);
    	...
    	{
    		lab3.rightMotor.setSpeed(270);
    		lab3.leftMotor.setSpeed(120 - diff);
    		lab3.rightMotor.forward();
    		lab3.leftMotor.forward();
    	}
    ...
    {
    	//left turn
    	lab3.rightMotor.setSpeed(100 - diff);
