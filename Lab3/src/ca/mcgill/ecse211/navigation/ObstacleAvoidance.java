...
/***
 * This class implements the navigation and obstacle avoidance of Lab3 on the
 * EV3 platform.
 * 
 * @authorAbedAtassi
 * @authorHyunSuAn
...
public class ObstacleAvoidance implements Runnable {
	...
	private double[][] wayPoints = new double[][] { { 1 * 30.48, 0 * 30.48 }, // change values for different maps
			{ 2 * 30.48, 1 * 30.48 }, { 2 * 30.48, 2 * 30.48 }, { 0 * 30.48, 2 * 30.48 }, { 1 * 30.48, 1 * 30.48 } };
	private int var;
	...
	/***
	 * This method is required to run the thread
	 * 
	 * 
	 * 
	 */
	...
	void travelTo(double x, double y) {
		...
		while (isNavigating()) { // avoiding obstacle
